...
// public DatabaseUseTool(ManusProperties manusProperties, DataSourceService
// dataSourceService,
...
// return """
// Interact with database, execute SQL, table structure, index, health status and other
// operations. Supported operations include:
// - 'execute_sql': Execute SQL statements (use NULL for null values)
...
// Important: When inserting NULL values, use NULL keyword explicitly (e.g., VALUES
// ('name', NULL, NULL)).
// """;
// }
...
// "text": { "type": "string", "description": "Chinese table name or table description to
// search, supports single query only" },
// "datasourceName": { "type": "string", "description": "Data source name, optional" }
// },
...
// "text": { "type": "string", "description": "Fuzzy search table description, leave empty
// to get all tables" },
// "datasourceName": { "type": "string", "description": "Data source name, optional" }
// },
// "required": ["action"],
...
// "datasourceName": { "type": "string", "description": "Data source name, leave empty to
...
// return new ToolExecuteResult("Database action '" + action + "' failed: " +
// e.getMessage());
// }
// }
